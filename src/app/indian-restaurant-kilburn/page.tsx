...
export const metadata = {
  ...
  description: "Bombay Bicycle Chef is a modern Indian restaurant in Kilburn (24 Willesden Ln, NW6). Dine in for modern Indian cooking — the best Indian food near Kilburn. Book a table.",
  ...
  openGraph: { title: "Indian Restaurant in Kilburn | Bombay Bicycle Chef", description: "The best Indian food in Kilburn — modern Indian cooking on Willesden Lane, NW6.", url: "/indian-restaurant-kilburn", images: [branch.image], type: "website" },
};
