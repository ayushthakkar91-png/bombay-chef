...
export const metadata = {
  ...
  description: "Bombay Bicycle Chef is a modern Indian restaurant in Balham (88 Balham High Rd, SW12). Dine in, order Indian takeaway or get delivery — the best Indian food near Balham. Book a table or order online.",
  ...
  openGraph: { title: "Indian Restaurant in Balham | Bombay Bicycle Chef", description: "The best Indian food in Balham — dine in, takeaway and delivery. Modern Indian cooking on Balham High Road, SW12.", url: "/indian-restaurant-balham", images: [branch.image], type: "website" },
};
