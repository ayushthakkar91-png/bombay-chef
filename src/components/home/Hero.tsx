...
export function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 w-full max-w-[1440px] mx-auto px-6 md:px-12 pt-28 lg:pt-32 pb-12 text-center flex flex-col items-center">
        <div className="flex flex-col items-center">
          {/* Label */}
          <span 
            className="text-[#A88442] text-[13px] tracking-[0.25em] font-semibold uppercase mb-4 md:mb-6 font-sans"
          >
          ...
          {/* Heading */}
          <h1 
            className="font-serif text-[#F5F0E6] mb-6 md:mb-8 tracking-wide font-medium"
          ...
          {/* Subheading */}
          <p 
            className="text-[18px] text-[#F5F0E6] opacity-90 max-w-[700px] mx-auto mb-8 font-sans tracking-wide"
