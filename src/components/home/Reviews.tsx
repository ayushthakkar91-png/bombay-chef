    ...
    <section className="bg-[#2B241D] w-full pt-20 pb-20 lg:pt-[90px] lg:pb-[90px] px-6">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="text-center max-w-[900px] mx-auto mb-12 lg:mb-16">
          <span className="text-[#A88442] text-[13px] tracking-[0.2em] font-semibold uppercase mb-4 block font-sans">
            Guest Stories
          </span>
        ...
        >
          {TESTIMONIALS.map((t, i) => (
            <motion.div key={i} variants={fade} className="flex flex-col items-center text-center">
              ...
              <span className="text-[#A88442]/40 text-[80px] leading-none font-serif select-none mb-4">&ldquo;</span>
              <p className="text-2xl md:text-3xl font-serif text-[#F5F0E6] leading-snug mb-8">
                {t.quote}
              </p>
              <div className="w-12 h-[1px] bg-[#A88442]/40 mb-6" />
              <p className="text-[#EFE6D8]/60 text-sm tracking-[0.1em] uppercase">
                {t.author}
              </p>
              <p className="text-[#A88442]/60 text-xs tracking-[0.15em] uppercase mt-1">
                {t.location}
              </p>
            </motion.div>
          ))}
