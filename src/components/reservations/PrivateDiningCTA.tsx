  ...
  return (
    <section ref={containerRef} className="relative w-full h-[80vh] lg:h-[100vh] overflow-hidden flex items-center justify-center">
      ...
      <div ref={bgRef} className="absolute inset-0 w-full h-[130%] -top-[15%]">
        ...
        />
        {/* Luxury dark tint */}
        <div className="absolute inset-0 bg-[#2A211C]/70 mix-blend-multiply" />
      ...
      <div className="relative z-10 text-center px-6 max-w-[900px] flex flex-col items-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-10 text-[#F6F2EA]/80 font-sans text-[14px] uppercase tracking-[0.15em] mb-16 flex-wrap">
