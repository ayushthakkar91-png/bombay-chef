...
export function FinalReservationCTA() {
  ...
  const scrollToForm = () => {
    ...
    if (element) {
      window.scrollTo({
        top: element.offsetTop - 110, // Offset for navbar
        behavior: "smooth"
      });
    }
  };
  ...
  return (
    <section className="relative bg-[#2A211C] w-full py-24 lg:py-[180px] px-6 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[900px] mx-auto text-center flex flex-col items-center">
        <h2 className="text-[48px] sm:text-[64px] md:text-[80px] lg:text-[100px] font-serif text-[#F6F2EA] leading-[1] mb-16">
          Your Table Awaits
        </h2>
